...
from models.CycleGanNIR_model_gen import *
...
if __name__ == '__main__':
    ...
    dataset= VCIPNir2RGBDataset_gen(opt) # create dataset
    ...
    model = CycleGANModel_gen(opt)       # create a model given opt.model and other options
